...
function init() {
  ...
  let arrOne = [];
   ...
   maxK = document.getElementById("maxK");
    ...
    let numberK=document.getElementById("numberK");
    let btnSendDiv = document.getElementById("btnSendDiv");
    ...
    btnSend.onclick = function () {
        ...
        sendHttpRequest("api/Num/numK", function (success, response) {
            if (success == true) {
                alert(response);
            }
    ...
    btnSendDiv.appendChild(btnSend);
